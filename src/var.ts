...
export const MARGIN_LEFT = 90;
export const VERTICAL_START = 30;
export const LINE_HEIGHT = 20;

export const TOP_WIDTH = 330;
export const SMALL_RIGHT_HEIGTH = 100;
...
export const SALON_WIDTH_1 = 105;
export const SALON_WIDTH_2 = 89;
export const SALON_WIDTH_3 = 141;
export const SSHH_WIDTH = 60;

export const ESCALERA_WIDTH = 35;
export const PASADIZO_HEIGHT1 = 30;
export const EDIFICIO2_WIDTH = 100;
export const EDIFICIO2_HEIGHT = 200;

export const EDIFICIO2_AULA_HEIGHT = 70;

export const PATIO2_HEIGHT = 240;

export const KIOSKO_HEIGHT = 45;
